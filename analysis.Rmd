...
for(angle in angles) {
  # Get observed data
  setwd(paste("C:/Users/sapetka/Box Sync/ROOTS/models/Rootbox_v6b/ROGER/Trial Data/Trial_Data_012/data_cylinder1-2_top",angle, sep=""))
  files = list.files(pattern="*.csv")
  # First apply read.csv, then rbind
  observed = do.call(rbind, lapply(files,   function(x) {
    ret<-read.csv(x, stringsAsFactors = FALSE, header=FALSE)
    ret$file <- x 
    ret
    }))
  ...
  df <- rbind(df,cbind(observed,true[-1],rep(angle,length(observed$V1))))
}
